...
# Prints the required code for isso comments
isso_body() {
	echo '<div><!--<h3>Ihre Meinungen:</h3>-->
                <section class="post-content">
                 <script data-isso="https://isso.apfelhammer.de/"
                      src="https://isso.apfelhammer.de/js/embed.min.js"></script>
...
# Prints the required FATHOM Analytics code to the footer
fathom_footer() {
    cat <<EOF
    ...
    })(document, window, '//fathom.apfelhammer.de/tracker.js', 'fathom');
    fathom('set', 'siteId', 'FGODV');
...
create_html_page() {
    ...
    # html, head
    {
        ...
        if [[ $index == no ]]; then
			...
			echo '<br /><hr style="width:75%;text-align:left;margin-left:5">'
...
create_includes() {
    ...
    if [[ -f $header_file ]]; then cp "$header_file" .header.html
		...
		echo '<link rel="canonical" href="https://apfelhammer.de">'
		        		
		echo ' <!-- Die H-Karte Junge -->'
		echo ' <div class="h-card" style="display: none;">'
		echo '    <a class="u-url" href="https://apfelhammer.de" style="display: none;">Apfelhammer</a>'
		echo '    <a class="u-url" href="https://thahipster.de" style="display: none;">thahipster.de</a>'
		echo ' <a class="u-url" href="https://herrmontag.de" style="display: none;">.macroblog HerrMontag.de</a>'
		echo ' <a class="u-url" href="https://janmontag.de" style="display: none;">.microblog JanMontag.de</a>'
		echo ' <p class="p-note">Herr Montag being the Web since 1997. Herr Montag works and lives in Erfurt, Thuringia, Germany.</p>'
		echo ' <p class="p-name">Jan Montag</p>'
		echo ' <img class="u-photo" src="https://apfelhammer.de/images/herrmontag.JPG" alt="Profilbild" style="display: none;">'
		echo ' </div>'
		echo ' <!-- Die H-Karte Junge --> '
		
		echo '		<!-- all rel mes -->'
		echo ' 			<link rel="me" href="mailto:hallo@herrmontag.de"> '
        echo '			<link rel="me" href="https://thahipster.de" />'
        echo '			<link rel="me" href="https://thafaker.crabdance.com" />'
        echo '			<link rel="me" href="https://janmontag.de" />'
        echo '			<link rel="me" href="https://thafaker.de" />'
        echo '			<link rel="me" href="https://herrmontag.de" />'
        echo '			<link rel="me" href="https://apfelhammer.de" />'
        echo '			<link rel="me" href="https://bsky.app/profile/herrmontag.de" />'
        echo '			<link rel="me" href="https://open.spotify.com/user/31pff5mvgaxh2npxksruczaef3li" />'
        echo '			<link rel="me" href="https://instagram.com/vinylisation/" />'
        echo '			<link rel="me" href="https://www.instagram.com/herr_montag_/" />'
        echo '			<link rel="me" href="https://twitter.com/ErfurterDom" />'
		echo '     		<link rel="me" href="https://mastodon.art/@herrmontag_de" />'
		echo ' 			<link rel="me" href="https://defcon.social/@apfelhammer" />'
		echo '			<link rel="me" href="hallo@herrmontag.de" />'
		echo '			<link rel="webmention" href="https://webmention.io/apfelhammer.de/webmention" />'
		echo '			<link rel="me" href="https://apfelhammer.de">'
		echo '			<link rel="pingback" href="https://webmention.io/apfelhammer.de/xmlrpc" />'
		...
		echo '			<link href="https://github.com/thafaker" rel="me">'
		echo '			<link rel="me" href="https://github.com/thafaker" />'
		echo '		<!-- all rel mes -->'
		
        echo '<!-- Favicon -->'
        echo '<link rel="icon" type="image/x-icon" href="/Logo/favicon.ico">'

        echo '<!-- Alternative icons for different devices -->'
        echo '<link rel="icon" type="image/png" sizes="16x16" href="/Logo/logo_16x16.png">'
        echo '<link rel="icon" type="image/png" sizes="32x32" href="/Logo/logo_32x32.png">'
        echo '<link rel="icon" type="image/png" sizes="64x64" href="/Logo/logo_64x64.png">'
        echo '<link rel="icon" type="image/png" sizes="128x128" href="/Logo/logo_128x128.png">'
        echo '<link rel="icon" type="image/png" sizes="256x256" href="/Logo/logo_256x256.png">'

        echo '<!-- Apple Touch Icon -->'
        echo '<link rel="apple-touch-icon" sizes="128x128" href="/Logo/logo_128x128.png">'
        echo '<link rel="apple-touch-icon" sizes="256x256" href="/Logo/logo_256x256.png">'
	...
	echo '<hr>'
        ...
        echo 'Part of famous thahipster network - <a href="https://thahipster.de">thahipster.de</a></div>'
		echo '<a href="https://xn--sr8hvo.ws/previous">←</a>'
		echo 'An <a href="https://xn--sr8hvo.ws">IndieWeb Webring</a> 🕸💍'
		echo '<a href="https://xn--sr8hvo.ws/next">→</a>'
	echo '<p>HITCOUNTER: You are visitor number <a href="http://stuff.mit.edu/doc/counter-howto.html"><img src="http://stuff.mit.edu/cgi/counter/apfelhammer" alt="several"></a></p>'
        } >> ".footer.html"
    fi
}
...
# Custom header (from config file)
